<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"D:\phpStudy\PHPTutorial\WWW\blog\public/../application/admin\view\tags\edit.html";i:1593678898;s:71:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\common\top.html";i:1593714286;s:72:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\common\left.html";i:1593594826;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>标签管理</title>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改标签信息</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <input type="hidden" name="t_id" value="<?php echo $tag['t_id']; ?>"/>
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">标签用户</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="tagname" placeholder="" name="tagname" value="<?php echo $tag['tagname']; ?>" type="text" >
<!--                                required="" -->
                            </div>
