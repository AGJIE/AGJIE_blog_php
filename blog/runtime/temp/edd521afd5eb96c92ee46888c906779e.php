<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"D:\phpStudy\PHPTutorial\WWW\blog\public/../application/admin\view\tags\lst.html";i:1593678814;s:71:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\common\top.html";i:1593714286;s:72:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\common\left.html";i:1593594826;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Tags/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td align="center"><?php echo $vo['t_id']; ?></td>
                                <td align="center"><?php echo $vo['tagname']; ?></td>
                                <td align="center">
                                    <a href="<?php echo url('tags/edit', array('id'=>$vo['t_id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('tags/del',array('id'=>$vo['t_id'])); ?>')" class="btn btn-danger btn-sm shiny">
