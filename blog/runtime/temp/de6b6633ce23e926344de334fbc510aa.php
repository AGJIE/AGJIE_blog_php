<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"D:\phpStudy\PHPTutorial\WWW\blog\public/../application/index\view\index\index.html";i:1593686911;s:74:"D:\phpStudy\PHPTutorial\WWW\blog\application\index\view\common\header.html";i:1593619512;s:73:"D:\phpStudy\PHPTutorial\WWW\blog\application\index\view\common\right.html";i:1593615749;s:72:"D:\phpStudy\PHPTutorial\WWW\blog\application\index\view\common\foot.html";i:1590812495;}*/ ?>
...
<div class="overall">
	...
	<div class="left">
		...
		<div class="xnews2">
			<div class="pic">
				<a target="_blank" href="<?php echo url('Article/article',array('article_id'=>$article['id'])); ?>">
				<?php if($article['pic'] != ''): ?>
			...
			<div class="dec">
				<h3><a target="_blank" href="<?php echo url('Article/article',array('article_id'=>$article['id'])); ?>"><?php echo $article['title']; ?></a></h3>
				<div class="time">发布时间：<?php echo date("Y年m月d日",$article['time']); ?></div>
