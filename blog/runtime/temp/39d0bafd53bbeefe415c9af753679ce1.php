<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"D:\phpStudy\PHPTutorial\WWW\blog\public/../application/index\view\cate\cate.html";i:1593679083;s:74:"D:\phpStudy\PHPTutorial\WWW\blog\application\index\view\common\header.html";i:1593619512;s:73:"D:\phpStudy\PHPTutorial\WWW\blog\application\index\view\common\right.html";i:1593615749;s:72:"D:\phpStudy\PHPTutorial\WWW\blog\application\index\view\common\foot.html";i:1590812495;}*/ ?>
...
<div class="overall">
	...
	<div class="left">
		...
		<div class="xnews2">
			...
			<div class="dec">
				<h3>
					<a target="_blank" href="<?php echo url('Article/article',array('article_id'=>$article['a_id'])); ?>"><?php echo $article['title']; ?></a>
				</h3>
			<div class="time">发布时间：<?php echo date("Y-m-d",$article['time']); ?>
			</div>
			<p><?php echo $article['desc']; ?></p>
			<div class="time">
				<a href='z97712.html'><?php echo $article['tagname']; ?></a>
			</div>
			</div>
		</div>
		<?php endforeach; endif; else: echo "" ;endif; ?>
