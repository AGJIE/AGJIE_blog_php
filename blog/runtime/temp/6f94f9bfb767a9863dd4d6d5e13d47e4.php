<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\phpStudy\PHPTutorial\WWW\blog\public/../application/admin\view\article\add.html";i:1593782048;s:71:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\common\top.html";i:1593714286;s:72:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\common\left.html";i:1593594826;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	    <meta charset="utf-8">
...
<!--                                required="" -->
                        ...
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">所属标签</label>
                            <div class="col-sm-6">
                                <select name="tagname">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="" id="url" name="pic"  type="file">
                                <!--                                required="" -->
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
